...
module.exports = function (scope, code, execution, console, timers, pmapi, PromiseProxy, onAssertion, options) {
    ...
    scope.exec(code, function (err) {
        ...
        // execution.return.async = timers.didExecuteAsynchronously();
        execution.return.async = timers.didExecuteAsynchronously() || timers.queueLength() > 0;
